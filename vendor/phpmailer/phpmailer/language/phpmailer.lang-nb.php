...
/**
 * Norwegian BokmÃƒÂ¥l PHPMailer language file: refer to English translation for definitive list
 * @package PHPMailer
 */

 $PHPMAILER_LANG['authenticate']         = 'SMTP-feil: Kunne ikke autentiseres.';
 $PHPMAILER_LANG['buggy_php']            = 'Din versjon av PHP er berÃƒÂ¸rt av en feil som kan fÃƒÂ¸re til ÃƒÂ¸delagte meldinger. For ÃƒÂ¥ lÃƒÂ¸se problemet kan du bytte til SMTP, deaktivere alternativet mail.add_x_header i php.ini, bytte til MacOS eller Linux eller oppgradere PHP til versjon 7.0.17+ eller 7.1.3+.';
 ...
 $PHPMAILER_LANG['execute']              = 'Kunne ikke utfÃƒÂ¸res: ';
 $PHPMAILER_LANG['extension_missing']    = 'Utvidelse mangler: ';
 $PHPMAILER_LANG['file_access']          = 'Kunne ikke fÃƒÂ¥ tilgang til filen: ';
 $PHPMAILER_LANG['file_open']            = 'Feil i fil: Kunne ikke ÃƒÂ¥pne filen: ';
 $PHPMAILER_LANG['from_failed']          = 'FÃƒÂ¸lgende Fra-adresse mislyktes: ';
 ...
 $PHPMAILER_LANG['mailer_not_supported'] = ' sender er ikke stÃƒÂ¸ttet.';
 $PHPMAILER_LANG['provide_address']      = 'Du mÃƒÂ¥ oppgi minst ÃƒÂ©n mottaker-e-postadresse.';
 $PHPMAILER_LANG['recipients_failed']    = 'SMTP Feil: FÃƒÂ¸lgende mottakeradresse feilet: ';
