...
$PHPMAILER_LANG['buggy_php']            = 'Din version af PHP er berÃƒÂ¸rt af en fejl, som gÃƒÂ¸r at dine beskeder muligvis vises forkert. For at rette dette kan du skifte til SMTP, slÃƒÂ¥ mail.add_x_header headeren i din php.ini fil fra, skifte til MacOS eller Linux eller opgradere din version af PHP til 7.0.17+ eller 7.1.3+.';
...
$PHPMAILER_LANG['file_access']          = 'Kunne ikke tilgÃƒÂ¥ filen: ';
...
$PHPMAILER_LANG['invalid_header']       = 'Ugyldig header navn eller vÃƒÂ¦rdi';
$PHPMAILER_LANG['invalid_hostentry']    = 'Ugyldig hostentry: ';
$PHPMAILER_LANG['invalid_host']         = 'Ugyldig vÃƒÂ¦rt: ';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP fejl: FÃƒÂ¸lgende modtagere fejlede: ';
