    ...
    public function dataSetLanguageSuccess()
    {
        ...
        return [
            ...
            'Available language: "Zh_Cn" (mixed case)' => [
                'phrase'   => 'Ã©â€šÂ®Ã¤Â»Â¶Ã¦Â­Â£Ã¦â€“â€¡Ã¤Â¸ÂºÃ§Â©ÂºÃ£â‚¬â€š',
                'langCode' => 'Zh_Cn',
            ],
            'Available language: "sr_latn"' => [
                'phrase'   => 'SadrÃ…Â¾aj poruke je prazan.',
                'langCode' => 'sr_latn',
            ],
    ...
    public function dataSetLanguageSuccessFallBackLogic()
    {
        ...
        return [
            ...
            'Request: "lang-script" (not available), receive "lang" even when "lang_country" exists' => [
                'phrase'   => 'Ã©Æ’ÂµÃ¤Â»Â¶Ã¥â€¦Â§Ã¥Â®Â¹Ã§â€šÂºÃ§Â©Âº',
                'langCode' => 'zh_Hant',
            ],
            ...
            'Request: "lang-country" (not available), receive "lang" even when "lang_script" exists' => [
                'phrase'   => 'ÃÂ¡ÃÂ°ÃÂ´Ã‘â‚¬ÃÂ¶ÃÂ°Ã‘Ëœ ÃÂ¿ÃÂ¾Ã‘â‚¬Ã‘Æ’ÃÂºÃÂµ Ã‘ËœÃÂµ ÃÂ¿Ã‘â‚¬ÃÂ°ÃÂ·ÃÂ°ÃÂ½.',
                'langCode' => 'sr_rs',
            ],
    ...
    public function dataLang()
    {
        return [
            ...
            'Key: "mailer_not_supported", explicit language: ja' => [
               ...
               'expected' => ' Ã£Æ’Â¡Ã£Æ’Â¼Ã£Æ’Â©Ã£Æ’Â¼Ã£ÂÅ’Ã£â€šÂµÃ£Æ’ÂÃ£Æ’Â¼Ã£Æ’Ë†Ã£Ââ€¢Ã£â€šÅ’Ã£ÂÂ¦Ã£Ââ€žÃ£ÂÂ¾Ã£Ââ€ºÃ£â€šâ€œÃ£â‚¬â€š',
               'langCode' => 'ja',
            ],
            ...
            'Key: "smtp_connect_failed", explicit language: es' => [
               'input'    => 'smtp_connect_failed',
               'expected' => 'SMTP Connect() fallÃƒÂ³. https://github.com/PHPMailer/PHPMailer/wiki/Troubleshooting',
               'langCode' => 'es',
            ],
