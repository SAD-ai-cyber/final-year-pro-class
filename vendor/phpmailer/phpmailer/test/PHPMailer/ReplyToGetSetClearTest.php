...
final class ReplyToGetSetClearTest extends PreSendTestCase
{
    ...
    public function testNoDuplicateReplyToAddresses()
    {
        ...
        self::assertTrue(
            $this->Mail->addReplyTo('test+replyto@franÃƒÂ§ois.ch', 'UTF8 domain'),
            'Initial address + name not queued'
        );
        self::assertFalse(
            $this->Mail->addReplyTo('test+replyto@franÃƒÂ§ois.ch'),
    ...
    public function testAddReplyToFailsOn8BitCharInDomainWithoutOptionalExtensions()
    {
        ...
        self::assertFalse($this->Mail->addReplyTo('test@franÃƒÂ§ois.ch'));
    }
    ...
    public function testClearReplyTos()
    {
        ...
        self::assertTrue($this->Mail->addReplyTo('test@franÃƒÂ§ois.ch'), 'IDN Address not queued');
