    ...
    public function dataMb_pathinfoWithoutOptions()
    {
        return [
            ...
            'Unix path with multibyte filename' => [
                'path'     => '/mnt/files/Ã©Â£â€ºÃ¥â€¦â€™Ã¦Â¨â€š Ã¥Å“ËœÃ¥â€¦â€°Ã¨Å’Â«.mp3',
                'expected' => [
                    'dirname'   => '/mnt/files',
                    'basename'  => 'Ã©Â£â€ºÃ¥â€¦â€™Ã¦Â¨â€š Ã¥Å“ËœÃ¥â€¦â€°Ã¨Å’Â«.mp3',
                    'extension' => 'mp3',
                    'filename'  => 'Ã©Â£â€ºÃ¥â€¦â€™Ã¦Â¨â€š Ã¥Å“ËœÃ¥â€¦â€°Ã¨Å’Â«',
                ],
            ],
            'Windows path with multibyte filename' => [
                'path'     => 'c:\mnt\files\Ã©Â£â€ºÃ¥â€¦â€™Ã¦Â¨â€š Ã¥Å“ËœÃ¥â€¦â€°Ã¨Å’Â«.mp3',
                'expected' => [
                    'dirname'   => 'c:\mnt\files',
                    'basename'  => 'Ã©Â£â€ºÃ¥â€¦â€™Ã¦Â¨â€š Ã¥Å“ËœÃ¥â€¦â€°Ã¨Å’Â«.mp3',
                    'extension' => 'mp3',
    ...
    public function dataMb_pathinfoWithOptions()
    {
        return [
            ...
            'Option: PATHINFO_BASENAME' => [
                ...
                'expected' => 'Ã©Â£â€ºÃ¥â€¦â€™Ã¦Â¨â€š Ã¥Å“ËœÃ¥â€¦â€°Ã¨Å’Â«.mp3',
            ],
            ...
            'Option: PATHINFO_FILENAME' => [
                ...
                'expected' => 'Ã©Â£â€ºÃ¥â€¦â€™Ã¦Â¨â€š Ã¥Å“ËœÃ¥â€¦â€°Ã¨Å’Â«',
            ],
            'Option: dirname' => [
                'options'  => 'dirname',
                'expected' => '/mnt/files',
