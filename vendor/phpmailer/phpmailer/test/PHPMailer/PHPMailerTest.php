...
EOT;
    ...
    public function testHtmlIso8859()
    {
        ...
        //This is the string 'ÃƒÂ©ÃƒÂ¨ÃƒÂ®ÃƒÂ¼ÃƒÂ§Ãƒâ€¦ÃƒÂ±ÃƒÂ¦ÃƒÅ¸' in ISO-8859-1, base-64 encoded
    ...
    {
        $this->Mail->isHTML(true);
        $this->Mail->Subject .= ': UTF-8 HTML ÃÅ¸Ã‘Æ’Ã‘ÂÃ‘â€šÃÂ¾ÃÂµ Ã‘â€šÃÂµÃÂ»ÃÂ¾ Ã‘ÂÃÂ¾ÃÂ¾ÃÂ±Ã‘â€°ÃÂµÃÂ½ÃÂ¸Ã‘Â';
...
<html lang="en">
    ...
    <body>
        <p>Chinese text: Ã©Æ’ÂµÃ¤Â»Â¶Ã¥â€¦Â§Ã¥Â®Â¹Ã§â€šÂºÃ§Â©Âº</p>
        <p>Russian text: ÃÅ¸Ã‘Æ’Ã‘ÂÃ‘â€šÃÂ¾ÃÂµ Ã‘â€šÃÂµÃÂ»ÃÂ¾ Ã‘ÂÃÂ¾ÃÂ¾ÃÂ±Ã‘â€°ÃÂµÃÂ½ÃÂ¸Ã‘Â</p>
        <p>Armenian text: Ã•â‚¬Ã•Â¡Ã•Â²Ã•Â¸Ã–â‚¬Ã•Â¤Ã•Â¡Ã•Â£Ã–â‚¬Ã•Â¸Ã–â€šÃ•Â©Ã•ÂµÃ•Â¸Ã–â€šÃ•Â¶Ã•Â¨ Ã•Â¤Ã•Â¡Ã•Â¿Ã•Â¡Ã–â‚¬Ã•Â¯ Ã•Â§</p>
        <p>Czech text: PrÃƒÂ¡zdnÃƒÂ© tÃ„â€ºlo zprÃƒÂ¡vy</p>
    </body>
</html>
EOT;
        $this->buildBody();
...
<html lang="en">
    ...
    <body>
        ...
        <p>Armenian text: Ã•â‚¬Ã•Â¡Ã•Â²Ã•Â¸Ã–â‚¬Ã•Â¤Ã•Â¡Ã•Â£Ã–â‚¬Ã•Â¸Ã–â€šÃ•Â©Ã•ÂµÃ•Â¸Ã–â€šÃ•Â¶Ã•Â¨ Ã•Â¤Ã•Â¡Ã•Â¿Ã•Â¡Ã–â‚¬Ã•Â¯ Ã•Â§</p>
        <p>Czech text: PrÃƒÂ¡zdnÃƒÂ© tÃ„â€ºlo zprÃƒÂ¡vy</p>
        Embedded Image: <img alt="phpmailer" src="cid:bÃƒÂ¤ck">
    </body>
</html>
EOT;
    ...
    public function testPlainUtf8()
    {
        ...
        $this->Mail->Body = <<<'EOT'
Chinese text: Ã©Æ’ÂµÃ¤Â»Â¶Ã¥â€¦Â§Ã¥Â®Â¹Ã§â€šÂºÃ§Â©Âº
Russian text: ÃÅ¸Ã‘Æ’Ã‘ÂÃ‘â€šÃÂ¾ÃÂµ Ã‘â€šÃÂµÃÂ»ÃÂ¾ Ã‘ÂÃÂ¾ÃÂ¾ÃÂ±Ã‘â€°ÃÂµÃÂ½ÃÂ¸Ã‘Â
Armenian text: Ã•â‚¬Ã•Â¡Ã•Â²Ã•Â¸Ã–â‚¬Ã•Â¤Ã•Â¡Ã•Â£Ã–â‚¬Ã•Â¸Ã–â€šÃ•Â©Ã•ÂµÃ•Â¸Ã–â€šÃ•Â¶Ã•Â¨ Ã•Â¤Ã•Â¡Ã•Â¿Ã•Â¡Ã–â‚¬Ã•Â¯ Ã•Â§
Czech text: PrÃƒÂ¡zdnÃƒÂ© tÃ„â€ºlo zprÃƒÂ¡vy
EOT;
        $this->buildBody();
        self::assertTrue($this->Mail->send(), $this->Mail->ErrorInfo);
        $msg = $this->Mail->getSentMIMEMessage();
...
<html lang="en">
  ...
  <body>
    ...
    public function testDuplicateIDNRemoved()
    {
        ...
        self::assertTrue($this->Mail->addAddress('test@franÃƒÂ§ois.ch'));
        self::assertFalse($this->Mail->addAddress('test@franÃƒÂ§ois.ch'));
        self::assertTrue($this->Mail->addAddress('test@FRANÃƒâ€¡OIS.CH'));
        self::assertFalse($this->Mail->addAddress('test@FRANÃƒâ€¡OIS.CH'));
    ...
    {
        self::assertFalse(PHPMailer::validateAddress('spÃ„Â±nÃŒË†altap@example.com', 'html5'));
        self::assertTrue(PHPMailer::validateAddress('spÃ„Â±nÃŒË†altap@example.com', 'eai'));
    }
    ...
    public function testStrangeUnicodeEmailAddresses()
    {
        ...
        self::assertTrue(PHPMailer::validateAddress('spÃ„Â±nÃŒË†altap@example.com'));
        self::assertTrue(PHPMailer::validateAddress('spÃ„Â±nÃŒË†altap@spÃ„Â±nÃŒË†altap.com'));
        self::assertTrue(PHPMailer::validateAddress('Ã Â¤Â¦Ã Â¥â€šÃ Â¤â€¢Ã Â¤Â¾Ã Â¤Â¨@Ã Â¤Â®Ã Â¥â€¡Ã Â¤Â°Ã Â¥â‚¬.Ã Â¤Â¦Ã Â¥â€šÃ Â¤â€¢Ã Â¤Â¾Ã Â¤Â¨.Ã Â¤Â­Ã Â¤Â¾Ã Â¤Â°Ã Â¤Â¤'));
        self::assertTrue(PHPMailer::validateAddress('Ã¦â€¦â€¢Ã§â€Â°Ã¥Â³ÂªÃ©â€¢Â¿Ã¥Å¸Å½@Ã¦â€¦â€¢Ã§â€Â°Ã¥Â³ÂªÃ©â€¢Â¿Ã¥Å¸Å½.Ã§Â½â€˜Ã¥Ââ‚¬'));
        self::assertFalse(PHPMailer::validateAddress('Ã¦â€¦â€¢Ã§â€Â°Ã¥Â³ÂªÃ©â€¢Â¿Ã¥Å¸Å½@Ã¦â€¦â€¢Ã§â€Â°Ã¥Â³ÂªÃ©â€¢Â¿Ã¥Å¸Å½Ã£â‚¬â€šÃ§Â½â€˜Ã¥Ââ‚¬'));
    }
    ...
    public function testAutomaticEaiValidation()
    {
        ...
        $this->Mail->Body = 'Test';
        $this->Mail->isSMTP();
        self::assertTrue($this->Mail->addAddress('spÃ„Â±nÃŒË†altap@example.com', ''));
        $this->Mail->preSend();
    ...
    public function testSmtpUTF8()
    {
        ...
        self::assertFalse($this->Mail->needsSMTPUTF8());
        $this->Mail->addAddress('foo@spÃ„Â±nÃŒË†altap.example', '');
        $this->Mail->preSend();
        self::assertFalse($this->Mail->needsSMTPUTF8());
        ...
        //Outlook.
        $this->Mail->addAddress('spÃ„Â±nÃŒË†altap@spÃ„Â±nÃŒË†altap.invalid', '');
        $this->Mail->preSend();
        self::assertStringContainsString('spÃ„Â±nÃŒË†altap@spÃ„Â±nÃŒË†altap.invalid', $this->Mail->createHeader());
        ...
        $this->Mail->Subject = 'SpÃ„Â±nÃŒË†al Tap';
        self::assertStringContainsString('SpÃ„Â±nÃŒË†al', $this->Mail->createHeader());
        $this->Mail->Body = 'SpÃ„Â±nÃŒË†al Tap';
        $this->Mail->preSend();
        self::assertStringContainsString('SpÃ„Â±nÃŒË†al', $this->Mail->createBody());
    }
    ...
    {
        $this->assertTrue($this->Mail->addAddress('test@franÃƒÂ§ois.ch'));
    }
