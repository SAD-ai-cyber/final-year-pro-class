    ...
    public function dataAddressSplitting()
    {
        return [
            ...
            'Valid address: single RFC2047 address folded onto multiple lines' => [
                ...
                'expected' => [
                    'default' => [
                        ['name' => 'Abcdefgh IjklmÃƒÂ± Ã¦Å“Æ’Ã¨Â­Â°Ã¥Â®Â¤Ã©Â ÂÃ§Â´â€žÃ§Â³Â»Ã§ÂµÂ±', 'address' => 'xyz@example.com'],
                    ],
                ],
            ],
            'Valid address: single RFC2047 address with space encoded as _' => [
                ...
                'expected' => [
                    'default' => [
                        ['name' => 'Abcdefgh ijklmÃƒÂ±', 'address' => 'xyz@example.com'],
                    ],
                ],
            ],
            ...
            'Valid address: multiple address, various formats, including one utf8-encoded name' => [
                ...
                'expected' => [
                    'default' => [
                        ...
                        [
                            'name'    => 'ÃÂÃÂ°ÃÂ·ÃÂ²ÃÂ°ÃÂ½ÃÂ¸ÃÂµ Ã‘â€šÃÂµÃ‘ÂÃ‘â€šÃÂ°',
