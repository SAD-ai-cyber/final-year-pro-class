...
<body>
    ...
    <div class="page-container flex-stack" style="padding: 20px;">
        ...
        <div class="form-container" style="flex: 2;">
            <h2>Add Teacher</h2>
            <form id="add-teacher-form" action="../includes/add_teacher.php" method="post" enctype="multipart/form-data">
                <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token, ENT_QUOTES, 'UTF-8'); ?>">

                <div class="form-row">
                    <div class="form-group">
                        <label for="add-name">Teacher Name *</label>
                        <input type="text" id="add-name" name="teacher_name" placeholder="Enter full name" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="tel" id="add-mobile" name="mobile_number" placeholder="Enter 10-digit mobile number"
                ...
                <div class="form-group">
                    <label for="teacher-photo">Upload Photo *</label>
                    <input type="file" id="teacher-photo" name="teacher_photo" accept="image/*" required>
                </div>

                <div class="button-container">
                    <button type="submit" name="add_teacher" class="btn btn-add">Add Teacher</button>
                </div>
            </form>
        </div>
        ...
        <div class="right-column" style="flex: 1; display: flex; flex-direction: column; gap: 32px;">
            <!-- Import Teachers (CSV/XLSX) -->
            <div class="form-container">
                <h2>Import Teachers (CSV/XLSX)</h2>
                <form action="../includes/add_teacher.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token, ENT_QUOTES, 'UTF-8'); ?>">
                    <div class="form-row">
                        <div class="form-group">
                            <label for="teacher-csv">Upload File *</label>
                            <input type="file" id="teacher-csv" name="teacher_csv" accept=".csv,.xlsx" required>
                        </div>
                    </div>
                    <div class="button-container">
                        <button type="submit" name="import_teachers" class="btn btn-add">Import Teachers</button>
                    </div>
                </form>
            </div>
            <!-- Remove Teacher -->
            <div class="form-container">
                ...
                <form id="delete-teacher-form" action="../includes/add_teacher.php" method="post">
                    <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token, ENT_QUOTES, 'UTF-8'); ?>">
                    <div class="form-row">
                        <div class="form-group">
                            <label for="delete-id">Teacher ID *</label>
                            <input type="number" id="delete-id" name="teacher_id" placeholder="Enter Teacher ID" required>
                        </div>
                        <div class="form-group">
                            <label for="delete-name">Teacher Name *</label>
                            <input type="text" id="delete-name" name="teacher_name_confirm" placeholder="Enter name to confirm" required>
                        </div>
                    </div>
                    <div class="button-container">
                        <button type="submit" name="Remove_Teacher" class="btn btn-remove">Remove Teacher</button>
                    </div>
                </form>
            </div>
        </div>
